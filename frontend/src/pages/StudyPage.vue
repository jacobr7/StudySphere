    ...
    <div class="study-page">
      ...
      <div class="container mt-4">
        ...
        <div class="study-flashcard">
          ...
          <button v-if="!showAnswer && currentFlashcard && currentFlashcard.f2" @click="revealAnswer" class="study-reveal-btn">
            Reveal Answer
          </button>
        </div>
      </div>
      ...
      <div class="study-controls">
        <button class="study-back-btn" @click="goBack">Back</button>
...
export default {
  ...
  .study-reveal-btn, .study-next-btn, .study-back-btn {
    padding: 10px 20px;
    border: none;
    border-radius: 8px;
    font-size: 1rem;
